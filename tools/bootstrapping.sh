...
/usr/bin/ccache /usr/bin/clang-6.0 -Wall -std=c++17 -I .generated/ -I src -I .build/ -MF .build/objects/src/rules/emit-passes.d -MD -c src/rules/emit-passes.cc -o .build/objects/src/rules/emit-passes.o
/usr/bin/ccache /usr/bin/clang-6.0 -Wall -std=c++17 -I .generated/ -I src -I .build/ -MF .build/objects/.generated/gen/rules/interface.d -MD -c .generated/gen/rules/interface.cc -o .build/objects/.generated/gen/rules/interface.o
/usr/bin/ccache /usr/bin/clang-6.0 -Wall -std=c++17 -I .generated/ -I src -I .build/ -MF .build/objects/src/rules/emit-passes-template.d -MD -c src/rules/emit-passes-template.cc -o .build/objects/src/rules/emit-passes-template.o
...
/usr/bin/ccache /usr/bin/clang-6.0 -Wall -std=c++17 -I .generated/ -I src -I .build/ -MF .build/objects/src/parser/parser_lowering.d -MD -c src/parser/parser_lowering.cc -o .build/objects/src/parser/parser_lowering.o
...
/usr/bin/clang-6.0 -Wall .build/objects/src/rules/tool.o .build/objects/src/parser/lowering_spec_lowering.o .build/objects/.generated/gen/parser/lowering_spec.o .build/objects/src/parser/parser_lowering.o .build/objects/src/parser/tokenizer_helper.o .build/objects/src/parser/tokens/regex_nfa_to_dfa.o .build/objects/src/parser/tokens/goto_dfa_emitter.o .build/objects/src/parser/patterns/lower_and_merge.o .build/objects/src/parser/patterns/type_check.o .build/objects/src/parser/patterns/emit_parser.o .build/objects/src/parser/types/emit_type_decls.o .build/objects/.generated/gen/parser/tokenizer-spec.o .build/objects/.generated/gen/parser/parser-spec.o .build/objects/src/rules/emit-passes-template.o .build/objects/.generated/gen/rules/interface.o .build/objects/src/rules/emit-passes.o .build/objects/src/rules/process.o .build/objects/.generated/gen/rules/rule-spec.o -lstdc++ -o .build/rules-dynamic
