...
/usr/bin/ccache /usr/bin/clang-6.0 -Wall -std=c++17 -I .generated/ -I src -I .build/ -MF .build/objects/src/rules/string-utils.d -MD -c src/rules/string-utils.cc -o .build/objects/src/rules/string-utils.o
