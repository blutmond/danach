...
/usr/bin/clang-6.0 -Wall .build/objects/src/rules/tool.o .build/objects/src/rules/rule-invoker.o .build/objects/src/gui/emit-buffer.o .build/objects/.generated/gen/gui/emit_manifest.o .build/objects/src/gui/buffer.o .build/objects/.generated/gen/rules/rule-spec.o .build/objects/src/parser/lowering_spec_lowering.o .build/objects/.generated/gen/parser/lowering_spec.o .build/objects/src/parser/parser_lowering.o .build/objects/src/parser/tokens/regex_nfa_to_dfa.o .build/objects/src/parser/tokens/goto_dfa_emitter.o .build/objects/src/parser/patterns/lower_and_merge.o .build/objects/src/parser/patterns/type_check.o .build/objects/src/parser/patterns/emit_parser.o .build/objects/src/parser/types/emit_type_decls.o .build/objects/.generated/gen/parser/tokenizer-spec.o .build/objects/.generated/gen/parser/parser-spec.o .build/objects/src/parser/tokenizer_helper.o .build/objects/src/parser/ast-context.o .build/objects/src/rules/compiler.o .build/objects/src/rules/process.o .build/objects/src/rules/string-utils.o -lstdc++ -o .build/rules-dynamic
