...
/usr/bin/clang-6.0 -Wall .build/objects/src/parser/tool.o .build/objects/src/parser/tokenizer_helper.o .build/objects/src/parser/regex_nfa_to_dfa.o .build/objects/src/parser/goto_dfa_emitter.o .build/objects/src/parser/patterns/lower_and_merge.o .build/objects/src/parser/patterns/type_check.o .build/objects/src/parser/patterns/emit_parser.o .build/objects/src/parser/types/emit_type_decls.o .build/objects/.generated/gen/parser/tokenizer-spec.o .build/objects/.generated/gen/parser/parser-spec.o -lstdc++ -o .build/parser-dynamic
